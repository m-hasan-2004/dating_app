...
class IntellectualInfoHelpText:
    ...
    OPINION_WOMAN_JOB = _("Select your opinion about a woman's job and employment status.")
    ...
    TYPE_CONNECTION_FRIENDS = _("Specify the type of connection you prefer with friends.")
